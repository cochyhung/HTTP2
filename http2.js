...
function methods() {
    return control_header[Math.floor(Math.random() * meth.length)];
}
...
if (process.argv.length < 4){
  ...
  `)
    ...
    console.log('node ' +  'http2.js ' + '<URL> <TIME> <THREADS>');
    console.log('[UPDATE] Random methods')
    //console.log(process.argv.length);
    const ex = gradient.vice('HTTP/2 (Support HTTPS Only) \nEx. node http2.js https://www.google.com/ 100 5\ndeveloper: Cóc Hy Hùng')
    console.log(ex)
    process.exit(0);
}
